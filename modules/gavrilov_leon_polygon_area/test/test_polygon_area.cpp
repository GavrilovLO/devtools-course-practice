...
TEST(Gavrilov_Leon_PolygonAreaTest, can_create_polygon) {
...
TEST(Gavrilov_Leon_PolygonAreaTest, add_vertex_change_vertex_num) {
  Polygon p;
  double x = 1.5, y = 2.5;
  std::pair<double, double> vertex(x, y);
  p.addVertex(vertex);
...
TEST(Gavrilov_Leon_PolygonAreaTest, can_delete_existing_vertex) {
  Polygon p;
  double x = 1.5, y = 2.5;
  std::pair<double, double> vertex(x, y);
  p.addVertex(vertex);
...
TEST(Gavrilov_Leon_PolygonAreaTest, delete_vertex_change_vertex_num) {
  Polygon p;
...
TEST(Gavrilov_Leon_PolygonAreaTest, can_delete_existing_vertex_by_number) {
  Polygon p;
  double x = 1.5, y = 2.5;
  int n = 0;
  std::pair<double, double> vertex(x, y);
...
TEST(Gavrilov_Leon_PolygonAreaTest, cant_delete_not_existing_vertex_by_number) {
  Polygon p;
  double x = 1.5, y = 2.5;
  int n = 4;
  std::pair<double, double> vertex(x, y);
...
TEST(Gavrilov_Leon_PolygonAreaTest,
...
TEST(Gavrilov_Leon_PolygonAreaTest, cant_delete_empty_vertex) {
  Polygon p;
  int n = 0;
  ASSERT_ANY_THROW(p.deleteVertexByNumber(n));
}

TEST(Gavrilov_Leon_PolygonAreaTest, can_count_polygon_area) {
  Polygon p;
...
TEST(Gavrilov_Leon_PolygonAreaTest, cant_count_area_of_one_point) {
  Polygon p;
  double x = 1.5, y = 2.5;
  std::pair<double, double> vertex(x, y);
  p.addVertex(vertex);
...
TEST(Gavrilov_Leon_PolygonAreaTest, cant_count_area_of_two_points) {
  Polygon p;
  double x1 = 1.5, x2 = 1.4, y = 2.5;
  std::pair<double, double> vertex(x1, y);
  p.addVertex(vertex);
...
TEST(Gavrilov_Leon_PolygonAreaTest, correct_count_square_area) {
  Polygon p;
...
TEST(Gavrilov_Leon_PolygonAreaTest, correct_count_rectangle_area) {
  Polygon p;
...
TEST(Gavrilov_Leon_PolygonAreaTest, correct_count_triangle_area) {
  Polygon p;
...
TEST(Gavrilov_Leon_PolygonAreaTest, correct_count_trapezoid_area) {
  Polygon p;
